...
func reset_tilemaps():
	...
	var tilemap_layers: Array[TileMapLayer] = [
		...
		$Building/BuildingInteriorWalls,
...
func save_as_resource():
	...
	var chunk_map = group_tiles_by_chunk({
		...
		"ExteriorWall": $Building/BuildingExteriorWalls,
		"InteriorWall": $Building/BuildingInteriorWalls,
	...
	for chunk_id in chunk_map.keys():
		...
		for layer_name in chunk_map[chunk_id].keys():
			var tiles = chunk_map[chunk_id][layer_name]
...
func group_tiles_by_chunk(layers: Dictionary) -> Dictionary:
	...
	for layer_name in layers.keys():
		...
		for cell in used_cells:
			...
			chunk_map[chunk_id][layer_name].append({
